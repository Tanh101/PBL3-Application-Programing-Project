...
public class hien_thi_thong_bao_nv extends javax.swing.JFrame {
    ...
    public hien_thi_thong_bao_nv() {
        initComponents();
        
    }
    public hien_thi_thong_bao_nv(Model_message s) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 720, 300));
        ...
        jPanel1.add(jbtExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 430, 120, 50));
        ...
        jbtBack.setColor(new java.awt.Color(51, 255, 153));
        ...
        jPanel1.add(jbtBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 60, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hien_thi_thong_bao_nv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new hien_thi_thong_bao_nv().setVisible(true);
            }
        });
    }
