...
import view.*;
import view.NotificationToStaff.*;
import controller.NotificationListener;
import javax.swing.JOptionPane;
import model.Model_message;

public class ViewNotificatiom extends javax.swing.JFrame {
    ...
    public ViewNotificatiom() {
        initComponents();
        
    }
    public ViewNotificatiom(Model_message s) {
        initComponents();
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewNotificatiom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewNotificatiom().setVisible(true);
            }
        });
    }
