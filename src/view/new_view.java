...
public class new_view extends javax.swing.JFrame {
    ...
    public new_view(Model_message s) {
        initComponents();
...
//    }
    ...
    private void jbtBackMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbtBackMouseClicked
       new Information(1).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(new_view.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
